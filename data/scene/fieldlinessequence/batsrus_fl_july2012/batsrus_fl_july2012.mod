...
-----------------------------------------------DOUBLE TIMESTEP---------------------------------------------------------
{
        Name = "FL_BATSRUS_Artificial_DTimeStep-OpenClosed",
        Parent = "GSMReferenceFrame",
        Renderable = {
            Type = "RenderableFieldlinesSequence",
            TracingMethod = "PreTracedBinary",
            SourceFolder = lutzArtificialBatsrusMagnetic..'double-timestep/open-closed/',
            -- StartStateOffset = 1080,
            -- StateStepSize = 100,
            -- MaxNumStates = 12,
            ...
            DefaultColor = {0.7,0.4,0,0.18},
            RadialDomainLimits = {0, 350},
            CartesianDomainLimits = {{-400, 60},{-80,80},{-32,32},},
        },
    },
        {
        Name = "FL_BATSRUS_Artificial_DTimeStep-throughout",
        Parent = "GSMReferenceFrame",
        Renderable = {
            Type = "RenderableFieldlinesSequence",
            TracingMethod = "PreTracedBinary",
            SourceFolder = lutzArtificialBatsrusMagnetic..'double-timestep/throughout/',
            -- StartStateOffset = 1080,
            -- StateStepSize = 100,
            -- MaxNumStates = 12,
            LoadBinariesAtRuntime = false,
